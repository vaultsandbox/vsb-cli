...
- `--persistence` flag for `inbox create` to request persistent or ephemeral inboxes
- Persistence, encryption, and email auth status displayed in `inbox info` and JSON output
